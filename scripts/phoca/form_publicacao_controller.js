...
const CONSTANTES = {
  ...
  *********************************************************/
  URL_PHOCA_FILES_UPLOAD: 'https://saude.rr.gov.br/transparencia-local/administrator/index.php?option=com_phocadownload&view=phocadownloadmanager&manager=file&tmpl=component&field=jform_filename&folder='
...
const Editais = {
  ...
  handle: function (title) {
    ...
    else if (UtilitariosFormPublicacao.verificar_se_titulo_tem_match_esperado(title, 'resposta à impugnação e pedido de esclarecimento')) {
      this.respostaImpugnacaoPedidoEsclarecimento(title);
    }
  ...
  respostaImpugnacaoPedidoEsclarecimento: function (title) {
